...
void setup() {
  ...
  idea[0]=loadImage("idea1.png");
  idea[1]=loadImage("idea2.png");
  idea[2]=loadImage("idea3.png");
...
void draw () {
  ...
  if (estado == 8) { //PANTALLA FINAL
    ...
    fill(255);
    textAlign(LEFT);
    text("Creditos", 200, 550);
  }
  if (estado == 9) { //CREDITOS
    background(255);
    fill(0);
    textSize(50);
    textAlign(CENTER);
    ...
    fill(255);
    textAlign(LEFT);
    text("Volver al inicio", 200, 550);
  }

  if ( ideaCerdito == 9) { //pantalla 10 con su texto
    image(idea[0], 0, 0, 600, 600);
    fill(0);
    textSize(15);
    textAlign(CENTER);
    text( texto[9], 35, 20, 500, 600 );
  }
  if ( ideaCerdito == 10) { //pantalla 11 con su texto
    image(idea[1], 0, 0, 600, 600);
    fill(0);
    textSize(15);
    textAlign(CENTER);
    text( texto[10], 35, 20, 500, 600 );
  }
  if ( ideaCerdito == 11) { //pantalla 12 con su texto
    image(idea[2], 0, 0, 600, 600);
    fill(0);
    textSize(15);
    textAlign(CENTER);
    text( texto[11], 35, 20, 500, 600 );
  }
}
...
void keyPressed() {
  if (keyCode == RIGHT) {
    estado++; // Cambia a la siguiente pantalla al presionar la flecha derecha
  }
